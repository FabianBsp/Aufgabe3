...
public class HofstadterRules_HofstadterParameters {
	/** SUT type. */
	...
	public static Iterable<Object[]> generate() {
		return Arrays.asList(new Object[][] {
				...
				{ "13", "Player A: 1, Player B: 3" }, { "5545", "Player A: 14, Player B: 5" },
				{ "5554", "Player A: 5, Player B: 14" }, { "1313", "Player A: 2, Player B: 6" },
