...
public class TwoPointsDifferentRules_InstableGameParameters {
	/** SUT type. */
	...
	public static Iterable<Object[]> generate() {
		return Arrays.asList(new Object[][] {
				...
				{ "12", "Player A: 3, Player B: 0" }, { "15", "Player A: 0, Player B: 6" },
				{ "22", "Player A: 2, Player B: 2" }, { "13", "Player A: 0, Player B: 4" },
				{ "4545", "Player A: 18, Player B: 0" }, { "4553", "Player A: 17, Player B: 0" },
