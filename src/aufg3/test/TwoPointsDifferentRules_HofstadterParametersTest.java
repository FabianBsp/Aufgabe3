...
public class TwoPointsDifferentRules_HofstadterParametersTest {
	/** SUT type. */
	...
	public static Iterable<Object[]> generate() {
		return Arrays.asList(new Object[][] {
				...
				{ "11", "Player A: 1, Player B: 1" }, { "55", "Player A: 5, Player B: 5" },
				{ "12", "Player A: 3, Player B: 0" }, { "21", "Player A: 0, Player B: 3" },
				{ "13", "Player A: 0, Player B: 4" }, { "5545", "Player A: 14, Player B: 5" },
				{ "5554", "Player A: 5, Player B: 14" }, { "1313", "Player A: 0, Player B: 8" },
				{ "4545", "Player A: 18, Player B: 0" }, { "35533553355335533553", "Player A: 32, Player B: 40.+Player B wins" },
				{ "35533553355335535352", "Player A: 40, Player B: 32.+Player A wins" },
				{ "35533553355335532553", "Player A: 40, Player B: 39.+Player A wins" },
				{ "35533553355335535555", "Player A: 42, Player B: 42.+Tie" },
				{ "35533553355335535545", "Player A: 46, Player B: 37.+Player A wins" },
				{ "35533553355335535554", "Player A: 37, Player B: 46.+Player B wins" }, { "", "." }, // Stopper, ohne
																										// Funktion
		});
	}
