...
public class TwoPointsDifferentRules_ShortGameParameters {
	/** SUT type. */
	...
	public static Iterable<Object[]> generate() {
		return Arrays.asList(new Object[][] {
				...
				{ "12", "Player A: 3, Player B: 0" }, { "22", "Player A: 2, Player B: 2" },
				{ "13", "Player A: 0, Player B: 4" }, { "31", "Player A: 4, Player B: 0" },
				{ "3323", "Player A: 8, Player B: 3" }, { "3333", "Player A: 6, Player B: 6" },
				{ "33333333", "Player A: 12, Player B: 12.+Tie" },
				{ "1313", "Player A: 0, Player B: 8" }, { "2323", "Player A: 10, Player B: 0" },
