...
public class SamePointsRules_ShortGameParameters {
	/** SUT type. */
	...
	public static Iterable<Object[]> generate() {
		return Arrays.asList(new Object[][] {
				...
				{ "11", "Player A: 0, Player B: 0" }, { "33", "Player A: 0, Player B: 0" },
				{ "12", "Player A: 3, Player B: 0" }, { "21", "Player A: 0, Player B: 3" },
				{ "13", "Player A: 1, Player B: 3" }, { "31", "Player A: 3, Player B: 1" },
				{ "3323", "Player A: 11, Player B: 0" }, { "3332", "Player A: 0, Player B: 11" },
				{ "1313", "Player A: 2, Player B: 6" }, { "2323", "Player A: 10, Player B: 0" },
				{ "2332233222", "Player A: 10, Player B: 10" },
				{ "233223322223", "Player A: 19, Player B: 10" },
				{ "33333333", "Player A: 0, Player B: 0.+Tie" },
				{ "111112111121", "Player A: 7, Player B: 7" },
				{ "2332233223", "Player A: 15, Player B: 10.+Player A wins" },
				{ "2332233232", "Player A: 10, Player B: 15.+Player B wins" },
				{ "233212211112", "Player A: 13, Player B: 8.+Player A wins" },
				{ "233212211121", "Player A: 8, Player B: 13.+Player B wins" },
				{ "", "." }, // Stopper, ohne
																										// Funktion
		});
	}
